                ...
                <main id="main">
                    ...
                    <div className="container">
                        ...
                        <span className="img img1">
                            <img src={process.env.PUBLIC_URL+"/images/m_2021_chiristmas2_slogan.png"} alt="img"/>
                        </span>

                        <span className="star star1">
                            <img src={process.env.PUBLIC_URL+"/images/2021_chiristmas2_bg_left.png"} alt="img"/>
                        </span>

                        <span className="star star2">
                            <img src={process.env.PUBLIC_URL+"/images/2021_chiristmas2_bg_right.png"} alt="img"/>
                        </span>

                        <span className="img img2">
                            <img src={process.env.PUBLIC_URL+"/images/2021_christmas2_drink.png"} alt="img"/>
                        </span>

                        <span className="img img3">
                            <img src={process.env.PUBLIC_URL+"/images/2021_christmas2_drink2.png"} alt="img"/>
                        </span>

                        <span className="img img4">
                            <img src={process.env.PUBLIC_URL+"/images/2021_christmas2_drink3.png"} alt="img"/>
                        </span>
