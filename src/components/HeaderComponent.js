                    ...
                    <div className="nav-box">
                        ...
                        <ul>
                            ...
                            <div className="find-box">
                                ...
                                <img src={process.env.PUBLIC_URL+"/images/icon_magnifier_black.png"} alt="zoom icon"/>
                                </a>
                            </div>
                            </li>
                        </ul>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <div className="sub-bottom">
                                    <div className="sub-container">
                                        <dl>
                                            <dt><a href="#">나이트로 콜드 브루 <img src={process.env.PUBLIC_URL+"/images/icon_gnb_new.png"} alt="new icon"/></a></dt>
                        ...
                        <div id="mobile">
                            <ul>
                                <li><a href="#" className="login-btn"><img src={process.env.PUBLIC_URL+"/images/icon_user_m.png"} alt="user icon"/></a></li>
                                <li><a href="#" className="maps-btn"><img src={process.env.PUBLIC_URL+"/images/icon_spot_m.png"} alt="spot icon"/></a></li>
                                <li><a href="#" className="berger-btn"><img src={process.env.PUBLIC_URL+"/images/btn_berger_m.png"} alt="burger icon"/></a></li>
                            </ul>
                        </div>
