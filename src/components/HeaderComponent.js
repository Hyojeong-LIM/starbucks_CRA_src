            ...
            <>
                 <header id="header">
                    ...
                    <div className="nav-box">
                        ...
                        <div id="mobile">
                            <ul>
                                <li><a href="#" className="login-btn"><img src="./images/icon_user_m.png" alt="user icon"/></a></li>
                                <li><a href="#" className="maps-btn"><img src="./images/icon_spot_m.png" alt="spot icon"/></a></li>
                                <li><a href="#" className="berger-btn"><img src="./images/btn_berger_m.png" alt="burger icon"/></a></li>
                            </ul>
                        </div>
