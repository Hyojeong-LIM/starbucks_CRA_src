                ...
                <nav id="mobileNav" className="">
                    <div className="mobile-container">
                        <span className="mobile-close">
                            <a href="#" className="mobile-close-btn"><img src={process.env.PUBLIC_URL+"/images/btn_gnb_close.png"} alt="close-btn"/></a>
                        </span>
                        <ul>
                            <li>
                            ...
                            <li>
                                ...
                                <div className="mobile-sub">
                                    <ul>
                                        <li><a href="#" className="non-sub">한눈에 보기</a></li>
                                        <li>
                                            <a href="#">My 리워드</a>
                                        ...
                                        <li><a href="#" className="non-sub">My 캘린더</a></li>
                                        <li><a href="#" className="non-sub">My 메뉴</a></li>
                                        <li><a href="#" className="non-sub">My 고객의 소리</a></li>
                                        <li><a href="#" className="non-sub">전자영수증</a></li>
                                        <li><a href="#" className="non-sub">개인컵 리워드 설정</a></li>
                                        <li><a href="#" className="non-sub">My DT Pass</a></li>
                                        <li>
                                            <a href="#">개인정보관리</a>
                                            <div className="mobile-sub-sub">
                                                <ul>
                            ...
                            <li>
                                ...
                                <div className="mobile-sub">
                                    <ul>
                                        ...
                                        <li><a href="#" className="non-sub">나와 어울리는 커피</a></li>
                                        <li>
                                            <a href="#">스타벅스 리저브™</a>
                                            <div className="mobile-sub-sub">
                                                <ul>
                            ...
                            <li>
                                ...
                                <div className="mobile-sub">
                                    <ul>
                                        ...
                                        <li><a href="#" className="non-sub">드라이브 스루 매장</a></li>
                                        <li><a href="#" className="non-sub">스타벅스 리저브™ 매장</a></li>
                                        <li><a href="#" className="non-sub">커뮤니티 스토어 매장</a></li>
                                        <li>
                                            <a href="#">매장 이야기</a>
                                            <div className="mobile-sub-sub">
                                                <ul>
                            ...
                            <li>
                                ...
                                <div className="mobile-sub">
                                    <ul>
                                        <li><a href="#" className="non-sub">한눈에 보기</a></li>
                                        <li><a href="#" className="non-sub">사회공헌 캠페인 소개</a></li>
                                        <li>
                                            ...
                                            <div className="mobile-sub-sub">
                                                <ul>
                                                    ...
                                                    <li><a href="#">청년지원 프로그램</a></li>
                                                    <li><a href="#">우리농산물 사랑 캠페인</a></li>
                            ...
                            <li>
                                ...
                                <div className="mobile-sub">
                                    <ul>
                                        ...
                                        <li><a href="#" className="non-sub">공지사항</a></li>
                                        <li><a href="#" className="non-sub">월페이퍼</a></li>
                                    </ul>
                                </div>                
                            </li>
                        </ul>
